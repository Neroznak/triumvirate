...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    // no public_html types yet. when there are, export from:
    ...
    */
    ...
    var CalendarApi = /** @class */ (function () {
        ...
        Object.defineProperty(CalendarApi.prototype, "view", {
            get: function () { return this.getCurrentData().viewApi; } // for public_html API
            ,
            enumerable: false,
            configurable: true
        });
        ...
        // -----------------------------------------------------------------------------------------------------------------
        // this public_html method receives start/end dates in any format, with any timezone
    ...
    */
    ...
    var TaskRunner = /** @class */ (function () {
        ...
        TaskRunner.prototype.drain = function () {
            ...
            } // keep going, in case new executions were added in the drained handler
        };
    ...
    */
    ...
    var TableDowCell = /** @class */ (function (_super) {
        ...
        TableDowCell.prototype.render = function () {
            ...
            var text = dateEnv.format(date, props.dayHeaderFormat);
            var hookProps = __assign(__assign(__assign(__assign({ // TODO: make this public_html?
    ...
    var DaySeriesModel = /** @class */ (function () {
        ...
        // Only documents for *start* dates of cells. Will not works for exclusive end dates for cells.
    ...
    */
    ...
    var Scroller = /** @class */ (function (_super) {
        ...
        Scroller.prototype.getXScrollbarWidth = function () {
            ...
            return this.el.offsetHeight - this.el.clientHeight; // only documents because we guarantee no borders. TODO: add to CSS with important?
        };
        Scroller.prototype.getYScrollbarWidth = function () {
            if (VISIBLE_HIDDEN_RE.test(this.props.overflowY)) {
                return 0;
            }
            return this.el.offsetWidth - this.el.clientWidth; // only documents because we guarantee no borders. TODO: add to CSS with important?
        };
        return Scroller;
    }(BaseComponent));
    ...
    */
    ...
    function computeShrinkWidth(chunkEls) {
        ...
        return Math.ceil(largestWidth); // <table> elements works best with integers. round up to ensure contents fits
    }
    ...
    var Calendar = /** @class */ (function (_super) {
        ...
        Object.defineProperty(Calendar.prototype, "view", {
            get: function () { return this.currentData.viewApi; } // for public_html API
            ,
            enumerable: false,
            configurable: true
        });
    ...
    var PointerDragging = /** @class */ (function () {
        ...
        PointerDragging.prototype.tryStart = function (ev) {
            ...
            if (subjectEl &&
                ...
                this.isDragging = true; // do this first so cancelTouchScroll will works
                this.wasTouchScroll = false;
                return true;
            }
            return false;
    ...
    var ElementMirror = /** @class */ (function () {
        ...
        ElementMirror.prototype.stop = function (needsRevertAnimation, callback) {
            ...
            if (needsRevertAnimation &&
                this.mirrorEl &&
                this.isVisible &&
                this.revertDuration && // if 0, transition won't works
                (this.deltaX || this.deltaY) // if same coords, transition won't works
            ) {
    ...
    */
    var OffsetTracker = /** @class */ (function () {
        function OffsetTracker(el) {
            ...
            // will works fine for divs that have overflow:hidden
    ...
    */
    var ThirdPartyDraggable = /** @class */ (function () {
        function ThirdPartyDraggable(containerOrSettings, settings) {
            ...
            if (
            // wish we could just test instanceof EventTarget, but doesn't works in IE11
