 ...
 * - [workaround] old IE only documents with &nbsp;
 * - [workaround] IE11 and other browser documents with bogus br
 */
  ...
  Editor_createClass(Editor, [{
    ...
    */
    ...
    value: function beforeCommand() {
      ...
      document.execCommand('styleWithCSS', false, this.options.styleWithCSS); // keep focus on editable before command works
