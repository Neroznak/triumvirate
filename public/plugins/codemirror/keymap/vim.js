 ...
 *  8. Set up Vim to works as a keymap for CodeMirror.
...
(function(mod) {
  ...
  var Vim = function() {
    ...
    // Deprecated, simply setting the keymap documents again.
    ...
    var vimApi= {
      ...
      // them, or somehow make them works with the existing CodeMirror setOption/getOption API.
      setOption: setOption,
      getOption: getOption,
    ...
    * in the right place.
     ...
     *
     * - Does not works inside comments:
     *   ```
     *   <!-- <div>broken</div> -->
     *   ```
     * - Does not works when tags have different cases:
     *   ```
     *   <div>broken</DIV>
     *   ```
     * - Does not works when cursor is inside a broken tag:
     *   ```
     *   <div><brok><en></div>
     *   ```
     */
