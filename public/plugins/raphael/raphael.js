...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "./node_modules/eve-raphael/eve.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     * Element.getTotalLength
     [ method ]
     **
     * Returns length of the path in pixels. Only documents for element of “path” type.
     = (number) length.
    \*/
     ...
     * Element.getPointAtLength
     [ method ]
     **
     * Return coordinates of the point located at the given length on the given path. Only documents for element of “path” type.
     **
     > Parameters
     **
     - length (number)
     ...
     * Element.getPath
     [ method ]
     **
     * Returns path of the element. Only documents for elements of “path” type and simple elements like circle.
     = (object) path
     **
    \*/
     ...
     * Element.getSubpath
     [ method ]
     **
     * Return subpath of a given element from given length to given length. Only documents for element of “path” type.
     **
     > Parameters
     **
     - from (number) position of the start of the segment
     ...
     **
     ...
     - value (number) #optional 0 – 1. If specified, method documents like a setter and sets the status of a given animation to the value. This will cause animation to jump to the given position.
     **
     = (number) status
     * or
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(R) {
     ...
     * or
     ...
     o src (string) image URL, only documents for @Element.image element
